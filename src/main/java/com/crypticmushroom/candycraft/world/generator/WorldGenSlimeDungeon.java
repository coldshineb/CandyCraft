...
public class WorldGenSlimeDungeon extends WorldGenerator {
    ...
    public void genColumn(World world, Random random, int x, int y, int z, boolean side, int id) {
        ...
        if (spawner != null) {
            spawner.getSpawnerBaseLogic().setEntityId(new ResourceLocation(mob == 0 ? "candycraftmod.SprinterSlime" : mob == 1 ? "candycraftmod.KamikazeSlime" : "candycraftmod.TornadoSlime"));
        }
