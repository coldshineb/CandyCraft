...
public class LayerUtilOverridden  {
    ...
    public static <T extends IArea, C extends IExtendedNoiseRandom<T>> IAreaFactory<T> func_227475_a_(WorldType p_227475_0_, CandylandsChunkGeneratorConfig p_227475_1_, LongFunction<C> p_227475_2_) {
        ...
        IAreaFactory<T> lvt_8_1_ = getBiomeLayer(p_227475_0_, iareafactory, p_227475_1_, p_227475_2_);
    ...
    public static Layer func_227474_a_(long p_227474_0_, WorldType p_227474_2_, CandylandsChunkGeneratorConfig p_227474_3_) {
        int i = 25;
    ...
    static <T extends IArea, C extends IExtendedNoiseRandom<T>> IAreaFactory<T> getBiomeLayer(WorldType worldType, IAreaFactory<T> parentLayer,
                                                                                              CandylandsChunkGeneratorConfig chunkSettings, LongFunction<C> contextFactory)
    {
        parentLayer = (new BiomeLayer(worldType.getWorldType(), chunkSettings.getBiomeId())).apply(contextFactory.apply(200L), parentLayer);
